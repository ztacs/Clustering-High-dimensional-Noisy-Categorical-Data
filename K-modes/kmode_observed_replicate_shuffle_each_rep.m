...
%data = data(randperm(size(data,1)),:);%RANDONLY SHUFFLE ROWS; %RANDONLY SHUFFLE ROWS; whether to
%shuffle in this step does not make much diffference;with shuffle 14.6973
%without shuffle: 14.9414
