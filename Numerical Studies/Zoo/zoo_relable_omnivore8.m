T =  readtable('W:\Multicategory clustering\zoodata\zoo_relabel herbivore8.csv',...
     'ReadVariableNames',false);
zoo_omnivore=table2array(T);
%zoo_cluster1=zoo_omnivore(zoo_omnivore(:,17)==1|zoo_omnivore(:,17)==3, :);
%ccdv2_original(zoo_cluster1)
for i=1:17
