%EDIT to the original ccdv2 code
%1. change to accmeasure, since correctrate does not work when number of clusters in true and observed clusters are different. 


%function [result,uni] = cate_clus1(data)
%function [correct_cn,cluster_center,com] = cate_clus17_try(data,mode)
function [correct_cn,cluster_center,cluster_all, total, pgain] = ccdv2_original_accmeasure(data)
...
%change to accmeasure, since correctrate does not work when number of clusters in true and observed clusters are different. 
[correct_cn]= AccMeasure(true_cluster, cluster_all); 
