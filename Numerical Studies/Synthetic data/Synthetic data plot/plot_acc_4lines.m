...
%s	k	ks sCAT		
if n==512 
Acc_result= xlsread('W:\JASA\Github - JASA submit_Nov_2022\Numerical Studies\Synthetic data\Synthetic data plot\Synthetic data.xlsx','512miss095_099_spe_km_ks_sCAT');
elseif n==1024
Acc_result= xlsread('W:\JASA\Github - JASA submit_Nov_2022\Numerical Studies\Synthetic data\Synthetic data plot\Synthetic data.xlsx','1024miss095_099_spe_km_ks_sCAT');
end
kk=0;
...
if n==512
    fname = 'W:\JASA\Github - JASA submit_Nov_2022\Numerical Studies\Synthetic data\Synthetic data plot\512\plot';
elseif n==1024
    fname = 'W:\JASA\Github - JASA submit_Nov_2022\Numerical Studies\Synthetic data\Synthetic data plot\1024\plot';
end
