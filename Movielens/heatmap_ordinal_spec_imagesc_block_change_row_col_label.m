% this code change the cluster label as specified in the code; 
% not a universal code 
%This code used for reviewer response, not for the main publish.
function [et I ] =heatmap_ordinal_spec_imagesc_block_change_row_col_label( r,r2,data,ran, filename ) 
...
set(gca, 'XTick', [1:1:n] , 'XTickLabel', x_label) 
     ...
     fname = 'C:\Users\Zhiyi\Desktop\W folder on Purdue server 07222021\Multicategory clustering\JASA\Matlab codes and data in JASA paper\Movielens';
%Set figure size
